...
PICS_URL = (environ.get('PICS', 'https://image2url.com/r2/default/images/1772360165170-81da9e56-998b-473c-b8f0-180879946d30.png')).split() #random anime girl img each time from aniwallpaper (Experimental)
PICS = (environ.get('PICS', 'https://image2url.com/r2/default/images/1772360832378-39e010f6-5c49-4aad-bde5-1cca5a34b8cc.jpg https://image2url.com/r2/default/images/1772360974639-6f9d6546-ec0c-4674-a738-7af43226ba3a.jpg https://image2url.com/r2/default/images/1772361016520-d011d4a8-e1ea-4b8e-aace-ebf73a22786b.jpg')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/e20b5fdaf217252964202.jpg")
MELCOW_PHOTO = environ.get("MELCOW_PHOTO", "https://image2url.com/r2/default/images/1772360165170-81da9e56-998b-473c-b8f0-180879946d30.png")
SPELL_IMG = environ.get("SPELL_IMG", "https://graph.org/file/13702ae26fb05df52667c.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://graph.org/file/242b7f1b52743938d81f1.jpg'))
FSUB_PICS = (environ.get('FSUB_PICS', 'https://graph.org/file/7478ff3eac37f4329c3d8.jpg https://image2url.com/r2/default/images/1772360165170-81da9e56-998b-473c-b8f0-180879946d30.png')).split()  # Fsub pic
#
# ============================
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002393558299').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003434095691'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003434095691'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003434095691'))  # Premium logs channel id
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1003146693570')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/S95Hub')  # Support group link (make sure bot is admin)

# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1003146693570")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1003418625613")# Channels for force sub (make sure bot is admin)

# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://image2url.com/r2/default/images/1772361172268-41afe0cf-a158-483f-9af4-7c209a085987.jpg')    # QR code image for payments
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1003418625613'))  # Notification of sent to your channel
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1003434095691')) #Verification Channel Id 
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1003434095691')) #If Anyone Set Your Bot In Any Group And Set Shortner In That Group Then In This Channel The All Details Come
VERIFY_IMG = environ.get("VERIFY_IMG", "https://telegra.ph/file/9ecc5d6e4df5b83424896.jpg")

TUTORIAL = environ.get("TUTORIAL", "https://t.me/S95Hub")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/S95Hub")   # Second tutorial link for verification
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+P8PNFT__ymlkYzll') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Shyam95bot') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/S95Hub') # Update channel link for the bot
...
DELETE_TIME = int(environ.get("DELETE_TIME", "36000"))  #  deletion time in seconds (default: 5 minutes). Adjust as per your needs.
...
FQDN = str(getenv('FQDN', 's95-hub.onrender.com'))
